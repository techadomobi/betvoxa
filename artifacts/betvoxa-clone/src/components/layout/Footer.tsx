...
export default function Footer() {
  return (
    <footer className="bg-[#171717] border-t border-[#2A2623] pt-16 pb-8 mt-0">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 pb-12 border-b border-[#2A2623]">
          {/* Brand */}
          <div className="lg:col-span-2">
            ...
            <p className="text-[#B4ABA0] text-sm leading-relaxed max-w-xs mb-6">
          ...
          {/* Casino */}
          <div>
            <h4 className="text-[#F5F0E8] font-semibold text-sm mb-4 uppercase tracking-wider">Casino</h4>
            <ul className="space-y-2.5">
              {["Casino Bonuses", "Free Spins", "No Deposit Bonuses", "VIP Programs", "Live Casino"].map((item) => (
                <li key={item}>
                  <Link href="/casino-bonuses">
                    <span className="text-[#C2B8AB] hover:text-[#F97316] text-sm transition-colors cursor-pointer">{item}</span>
                  </Link>
                </li>
              ))}
            </ul>
          ...
          {/* Sports */}
          <div>
            <h4 className="text-[#F5F0E8] font-semibold text-sm mb-4 uppercase tracking-wider">Sports</h4>
            <ul className="space-y-2.5">
          ...
          {/* Countries */}
          <div>
            <h4 className="text-[#F5F0E8] font-semibold text-sm mb-4 uppercase tracking-wider">Countries</h4>
            <ul className="space-y-2.5">
              {[
                ...
                <li key={c.code}>
                  <Link href={`/country/${c.code}`}>
                    <span className="text-[#C2B8AB] hover:text-[#F97316] text-sm transition-colors cursor-pointer">{c.name}</span>
                  </Link>
                </li>
              ))}
            </ul>
        ...
        <div className="py-6 border-b border-[#2A2623]">
          <p className="text-[#A89F94] text-xs leading-relaxed max-w-4xl">
            ...
            Resources are available at <span className="text-[#F97316]/70">GamCare</span>, <span className="text-[#F97316]/70">BeGambleAware</span>, and <span className="text-[#F97316]/70">Gamblers Anonymous</span>.
            BetVoxa only recommends licensed and regulated operators. Must be 18+ to bet. Please gamble responsibly.
          </p>
        </div>

        <div className="pt-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-[#A89F94] text-xs">
