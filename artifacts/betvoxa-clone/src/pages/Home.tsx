...
function CounterStat({ value, label, prefix = "", suffix = "" }: { value: number; label: string; prefix?: string; suffix?: string }) {
  ...
  return (
    <div ref={ref} className="text-center">
      <div className="text-4xl md:text-5xl font-serif font-bold text-[rgb(249, 115, 22)] mb-1">
...
export default function Home() {
  ...
  return (
    <div className="overflow-x-hidden">
      ...
      <section ref={heroRef} className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          {Array.from({ length: 24 }).map((_, i) => (
            <motion.div key={i} className="absolute w-1 h-1 rounded-full bg-[rgb(249, 115, 22)]/30"
        ...
        <motion.div style={{ opacity }} className="relative z-10 text-center px-4 max-w-5xl mx-auto pt-20">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.2 }}
            className="inline-flex items-center gap-2 bg-[rgb(249, 115, 22)]/8 border border-[rgb(249, 115, 22)]/12 rounded-full px-4 py-1.5 text-[rgb(249, 115, 22)] text-sm font-medium mb-6">
            <Star size={13} className="fill-[rgb(249, 115, 22)]" /> Trusted by 2M+ bettors worldwide
          </motion.div>
          <motion.h1 initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7, delay: 0.3 }}
            ...
            Best Betting &amp; <span className="text-[rgb(249, 115, 22)] text-glow">Casino Offers</span> Worldwide
          </motion.h1>
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.6 }}
            ...
            <Link href="/casino-bonuses" data-testid="button-hero-claim">
              <motion.button whileHover={{ scale: 1.04, boxShadow: "0 0 30px rgba(224,174,46,0.5)" }} whileTap={{ scale: 0.97 }}
                className="px-8 py-4 bg-[rgb(249, 115, 22)] text-[#0B0A09] rounded-xl font-bold text-lg hover:bg-[#DC6803] transition-all shadow-[0_0_20px_rgba(249,115,22,0.3)] flex items-center gap-2">
      ...
      {/* ─── STATS TICKER ─── */}
      <section className="bg-[rgb(249, 115, 22)]/5 border-y border-[rgb(249, 115, 22)]/10 py-14">
          ...
          >
            {[...recentWinners, ...recentWinners].map((w, i) => (
              <div key={i} className="flex items-center gap-2 text-sm flex-shrink-0">
                ...
                <span className="text-[rgb(249, 115, 22)] font-bold">{w.amount}</span>
      ...
      <section className="py-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-12">
          <div className="text-[rgb(249, 115, 22)] text-sm font-semibold uppercase tracking-widest mb-3">Hand-picked for you</div>
        ...
        <div className="text-center mt-8">
          <Link href="/casino-bonuses" data-testid="link-view-all-casinos">
            <motion.button whileHover={{ scale: 1.03 }} className="inline-flex items-center gap-2 px-6 py-3 border border-[rgb(249, 115, 22)]/12 text-[rgb(249, 115, 22)] rounded-lg hover:bg-[rgb(249, 115, 22)]/8 transition-colors font-medium">
      ...
      <section className="py-20 bg-[#F3F1EA]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-14">
            <div className="text-[rgb(249, 115, 22)] text-sm font-semibold uppercase tracking-widest mb-3">Know before you claim</div>
            ...
            {bonusTypes.map((b, i) => (
              <motion.div key={b.title}
                ...
                <div className="flex items-start justify-between mb-3">
                  <div className="w-11 h-11 rounded-xl bg-[rgb(249, 115, 22)]/8 border border-[rgb(249, 115, 22)]/12 flex items-center justify-center">
                    <b.icon size={20} className="text-[rgb(249, 115, 22)]" />
                  </div>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-14">
            <div className="text-[rgb(249, 115, 22)] text-sm font-semibold uppercase tracking-widest mb-3">Localised for you</div>
                ...
                <Link href={`/country/${c.code}`} data-testid={`link-country-card-${c.code}`}>
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <div>
                      ...
                      <div className="text-[rgb(249, 115, 22)] text-sm font-medium">{c.topBonus}</div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-1 text-[rgb(249, 115, 22)] text-sm font-medium group-hover:gap-2 transition-all">
      ...
      <section className="py-20 bg-[#F3F1EA]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-14">
            <div className="text-[rgb(249, 115, 22)] text-sm font-semibold uppercase tracking-widest mb-3">Bet on anything</div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            {popularSports.map((s, i) => (
              <motion.div key={s.name}
                ...
                <div className="text-[rgb(249, 115, 22)] text-xs font-medium mb-2">{s.markets} markets</div>
          ...
          <div className="text-center mt-10">
            <Link href="/betting-sites">
              <motion.button whileHover={{ scale: 1.03 }} className="inline-flex items-center gap-2 px-6 py-3 border border-[rgb(249, 115, 22)]/12 text-[rgb(249, 115, 22)] rounded-lg hover:bg-[rgb(249, 115, 22)]/8 transition-colors font-medium" data-testid="link-sports-all">
      ...
      <section className="py-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-16">
          <div className="text-[rgb(249, 115, 22)] text-sm font-semibold uppercase tracking-widest mb-3">Our promise</div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {trustFeatures.map((f, i) => (
            <motion.div key={f.title}
              initial={{ opacity: 0, y: 24 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: "-40px" }} transition={{ delay: i * 0.08 }}
              whileHover={{ y: -4 }}
              className="bg-white border border-[#ECE6DB] rounded-2xl p-6 hover:border-[rgb(249, 115, 22)]/12 transition-all duration-300">
              <div className="w-12 h-12 rounded-xl bg-[rgb(249, 115, 22)]/8 border border-[rgb(249, 115, 22)]/12 flex items-center justify-center mb-4">
                <f.icon size={22} className="text-[rgb(249, 115, 22)]" />
              </div>
      ...
      <section className="py-20 bg-[#F3F1EA]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-14">
            <div className="text-[rgb(249, 115, 22)] text-sm font-semibold uppercase tracking-widest mb-3">Deposit &amp; withdraw</div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
            {paymentMethods.map((pm, i) => (
              <motion.div key={pm.name}
                ...
                <div className="w-10 h-10 rounded-lg bg-[rgb(249, 115, 22)]/8 flex items-center justify-center mx-auto mb-3">
                  <CreditCard size={18} className="text-[rgb(249, 115, 22)]" />
                </div>
      ...
      <section className="py-20 bg-gradient-to-b from-[#0B0A09] via-[#1B3950]/10 to-[#0B0A09]">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-12">
            <div className="text-[rgb(249, 115, 22)] text-sm font-semibold uppercase tracking-widest mb-3">Transparency first</div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
            {[
              ...
              <motion.div key={item.label}
                ...
                <div className="text-2xl font-bold text-[rgb(249, 115, 22)] mb-1">{item.score}</div>
      ...
      <section className="py-20 bg-[#F3F1EA]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-14">
            <div className="text-[rgb(249, 115, 22)] text-sm font-semibold uppercase tracking-widest mb-3">Sports betting</div>
            ...
            {[
              ...
              <motion.div key={site.name}
                ...
                <div className="flex items-start justify-between mb-4">
                  <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-[rgb(249, 115, 22)]/20 to-[#1B3950]/40 border border-[#E7E1D6] flex items-center justify-center font-bold text-[rgb(249, 115, 22)] text-sm font-mono">{site.initials}</div>
                  <div className="flex">{Array.from({ length: 5 }).map((_, j) => <Star key={j} size={11} className={j < Math.round(site.rating) ? "fill-[rgb(249, 115, 22)] text-[rgb(249, 115, 22)]" : "fill-white/20 text-[#C9C3B8]"} />)}</div>
                </div>
                ...
                <div className="text-[rgb(249, 115, 22)] font-medium text-sm mb-3">{site.bonus}</div>
                <div className="flex flex-wrap gap-1.5 mb-4">
                ...
                <Link href="/betting-sites">
                  <button className="w-full py-2.5 border border-[rgb(249, 115, 22)]/12 text-[rgb(249, 115, 22)] rounded-lg text-sm font-medium hover:bg-[rgb(249, 115, 22)]/8 transition-colors flex items-center justify-center gap-1.5" data-testid={`button-visit-preview-${site.name.toLowerCase()}`}>
          ...
          <div className="text-center mt-8">
            <Link href="/betting-sites">
              <motion.button whileHover={{ scale: 1.03 }} className="inline-flex items-center gap-2 px-6 py-3 border border-[rgb(249, 115, 22)]/12 text-[rgb(249, 115, 22)] rounded-lg hover:bg-[rgb(249, 115, 22)]/8 transition-colors font-medium" data-testid="link-all-betting-sites">
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-14">
            <div className="text-[rgb(249, 115, 22)] text-sm font-semibold uppercase tracking-widest mb-3">What bettors say</div>
            ...
            {testimonials.map((t, i) => (
              <motion.div key={t.name}
                ...
                <div className="flex mb-3">
                  {Array.from({ length: t.rating }).map((_, j) => <Star key={j} size={14} className="fill-[rgb(249, 115, 22)] text-[rgb(249, 115, 22)]" />)}
                </div>
                <p className="text-[#4A433C] text-sm leading-relaxed mb-4 italic">"{t.text}"</p>
                <div className="flex items-center gap-2">
                  <div className="w-8 h-8 rounded-full bg-[rgb(249, 115, 22)]/15 flex items-center justify-center text-[rgb(249, 115, 22)] font-bold text-xs">{t.name[0]}</div>
                  <div>
      ...
      <section className="py-20 bg-[#F3F1EA]">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-gradient-to-r from-[#1B3950]/40 via-[rgb(249, 115, 22)]/5 to-[#1B3950]/40 border border-[rgb(249, 115, 22)]/12 rounded-3xl p-10 md:p-14 flex flex-col md:flex-row items-center gap-8">
            <div className="flex-1">
              <div className="text-[rgb(249, 115, 22)] text-sm font-semibold uppercase tracking-widest mb-3">Mobile experience</div>
              ...
              <div className="flex flex-wrap gap-3">
                {["iOS App", "Android App", "Mobile Browser", "Live Betting", "Push Notifications"].map((feat) => (
                  <span key={feat} className="flex items-center gap-1.5 bg-white border border-[#E7E1D6] text-[#5F554C] text-sm px-3 py-1.5 rounded-lg">
                    <CheckCircle size={12} className="text-[rgb(249, 115, 22)]" /> {feat}
                  </span>
                ))}
              </div>
            </div>
            <div className="flex gap-3">
              <div className="w-14 h-14 rounded-2xl bg-[rgb(249, 115, 22)]/8 border border-[rgb(249, 115, 22)]/12 flex items-center justify-center"><Smartphone size={28} className="text-[rgb(249, 115, 22)]" /></div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-r from-[#1B3950]/30 via-[rgb(249, 115, 22)]/5 to-[#1B3950]/30" />
        <div className="relative max-w-2xl mx-auto text-center px-4">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            <div className="text-[rgb(249, 115, 22)] text-sm font-semibold uppercase tracking-widest mb-3">Stay ahead</div>
            ...
            <div className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
              <input type="email" placeholder="Enter your email"
                className="flex-1 px-4 py-3 bg-white border border-[#DAD3C6] rounded-lg text-[#1F1A17] placeholder-white/30 focus:outline-none focus:border-[rgb(249, 115, 22)]/50 text-sm"
                data-testid="input-newsletter-email" />
              <motion.button whileHover={{ scale: 1.04 }} whileTap={{ scale: 0.97 }}
                className="px-6 py-3 bg-[rgb(249, 115, 22)] text-[#0B0A09] rounded-lg font-bold text-sm hover:bg-[#DC6803] transition-colors shadow-[0_0_20px_rgba(249,115,22,0.3)]"
      ...
      <section className="py-20 bg-[#F3F1EA]">
        <div className="max-w-3xl mx-auto px-4">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-12">
            <div className="text-[rgb(249, 115, 22)] text-sm font-semibold uppercase tracking-widest mb-3">Got questions?</div>
          ...
          <div className="flex flex-col gap-3">
            {faqs.map((faq, i) => (
              <motion.div key={i}
                ...
                className={`bg-white border rounded-xl overflow-hidden transition-all duration-300 ${openFaq === i ? "border-[rgb(249, 115, 22)]/12" : "border-[#ECE6DB]"}`}>
                <button onClick={() => setOpenFaq(openFaq === i ? null : i)}
                  ...
                  {openFaq === i ? <ChevronUp size={16} className="text-[rgb(249, 115, 22)] flex-shrink-0" /> : <ChevronDown size={16} className="text-[#8D847A] flex-shrink-0" />}
                </button>
                <AnimatePresence>
                  {openFaq === i && (
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white border border-[#ECE6DB] rounded-2xl p-8 flex flex-col md:flex-row items-start gap-6">
            <div className="w-12 h-12 rounded-xl bg-[#1B3950]/50 flex items-center justify-center flex-shrink-0">
              <Shield size={24} className="text-[rgb(249, 115, 22)]" />
            </div>
            <div>
      ...
      <section className="py-28 relative overflow-hidden bg-[#F8F7F2]">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
          ...
          <h2 className="font-serif text-5xl md:text-6xl font-bold text-[#1F1A17] mb-4">
            Ready to <span className="text-[rgb(249, 115, 22)] text-glow">Win Big?</span>
          </h2>
          ...
          <Link href="/casino-bonuses">
            <motion.button whileHover={{ scale: 1.05, boxShadow: "0 0 40px rgba(224,174,46,0.5)" }} whileTap={{ scale: 0.97 }}
              className="px-10 py-5 bg-[rgb(249, 115, 22)] text-[#0B0A09] rounded-xl font-bold text-xl hover:bg-[#DC6803] transition-all shadow-[0_0_30px_rgba(249,115,22,0.3)]"
