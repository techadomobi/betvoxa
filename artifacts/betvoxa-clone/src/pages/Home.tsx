    ...
    <div className="overflow-x-hidden">
      ...
      <section ref={heroRef} className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <motion.div style={{ opacity }} className="relative z-10 text-center px-4 max-w-5xl mx-auto pt-20">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.2 }}
            className="inline-flex items-center gap-2 bg-[#D97706]/8 border border-[#D97706]/12 rounded-full px-4 py-1.5 text-[#D97706] text-sm font-medium mb-6">
      ...
      <section className="py-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mt-8">
          <Link href="/casino-bonuses" data-testid="link-view-all-casinos">
            <motion.button whileHover={{ scale: 1.03 }} className="inline-flex items-center gap-2 px-6 py-3 border border-[#D97706]/12 text-[#D97706] rounded-lg hover:bg-[#D97706]/8 transition-colors font-medium">
            ...
            {bonusTypes.map((b, i) => (
              <motion.div key={b.title}
                ...
                <div className="flex items-start justify-between mb-3">
                  <div className="w-11 h-11 rounded-xl bg-[#D97706]/8 border border-[#D97706]/12 flex items-center justify-center">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mt-10">
            <Link href="/betting-sites">
              <motion.button whileHover={{ scale: 1.03 }} className="inline-flex items-center gap-2 px-6 py-3 border border-[#D97706]/12 text-[#D97706] rounded-lg hover:bg-[#D97706]/8 transition-colors font-medium" data-testid="link-sports-all">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {trustFeatures.map((f, i) => (
            <motion.div key={f.title}
              initial={{ opacity: 0, y: 24 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: "-40px" }} transition={{ delay: i * 0.08 }}
              whileHover={{ y: -4 }}
              className="bg-white border border-[#ECE6DB] rounded-2xl p-6 hover:border-[#D97706]/12 transition-all duration-300">
              <div className="w-12 h-12 rounded-xl bg-[#D97706]/8 border border-[#D97706]/12 flex items-center justify-center mb-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
            {paymentMethods.map((pm, i) => (
              <motion.div key={pm.name}
                ...
                <div className="w-10 h-10 rounded-lg bg-[#D97706]/8 flex items-center justify-center mx-auto mb-3">
      ...
      <section className="py-20 bg-[#F3F1EA]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {[
              ...
              <motion.div key={site.name}
                ...
                <div className="flex items-start justify-between mb-4">
                  <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-[#D97706]/20 to-[#1B3950]/40 border border-[#E7E1D6] flex items-center justify-center font-bold text-[#D97706] text-sm font-mono">{site.initials}</div>
                  <div className="flex">{Array.from({ length: 5 }).map((_, j) => <Star key={j} size={11} className={j < Math.round(site.rating) ? "fill-[#D97706] text-[#D97706]" : "fill-white/20 text-[#C9C3B8]"} />)}</div>
                </div>
                ...
                <Link href="/betting-sites">
                  <button className="w-full py-2.5 border border-[#D97706]/12 text-[#D97706] rounded-lg text-sm font-medium hover:bg-[#D97706]/8 transition-colors flex items-center justify-center gap-1.5" data-testid={`button-visit-preview-${site.name.toLowerCase()}`}>
          ...
          <div className="text-center mt-8">
            <Link href="/betting-sites">
              <motion.button whileHover={{ scale: 1.03 }} className="inline-flex items-center gap-2 px-6 py-3 border border-[#D97706]/12 text-[#D97706] rounded-lg hover:bg-[#D97706]/8 transition-colors font-medium" data-testid="link-all-betting-sites">
      ...
      <section className="py-20 bg-[#F3F1EA]">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-gradient-to-r from-[#1B3950]/40 via-[#D97706]/5 to-[#1B3950]/40 border border-[#D97706]/12 rounded-3xl p-10 md:p-14 flex flex-col md:flex-row items-center gap-8">
            ...
            <div className="flex gap-3">
              <div className="w-14 h-14 rounded-2xl bg-[#D97706]/8 border border-[#D97706]/12 flex items-center justify-center"><Smartphone size={28} className="text-[#D97706]" /></div>
            </div>
          </div>
        </div>
      </section>
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            ...
            <div className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
              <input type="email" placeholder="Enter your email"
                className="flex-1 px-4 py-3 bg-white border border-[#DAD3C6] rounded-lg text-[#1F1A17] placeholder-white/30 focus:outline-none focus:border-[#D97706]/50 text-sm"
          ...
          <div className="flex flex-col gap-3">
            {faqs.map((faq, i) => (
              <motion.div key={i}
                ...
                className={`bg-white border rounded-xl overflow-hidden transition-all duration-300 ${openFaq === i ? "border-[#D97706]/12" : "border-[#ECE6DB]"}`}>
                <button onClick={() => setOpenFaq(openFaq === i ? null : i)}
                  ...
                  {openFaq === i ? <ChevronUp size={16} className="text-[#D97706] flex-shrink-0" /> : <ChevronDown size={16} className="text-[#8D847A] flex-shrink-0" />}
                </button>
                <AnimatePresence>
                  {openFaq === i && (
