...
function CounterStat({ value, label, prefix = "", suffix = "" }: { value: number; label: string; prefix?: string; suffix?: string }) {
  ...
  return (
    <div ref={ref} className="text-center">
      <div className="text-4xl md:text-5xl font-serif font-bold text-[#2563EB] mb-1">
  ...
  return (
    <div className="overflow-x-hidden">
      ...
      <section ref={heroRef} className="relative min-h-screen flex items-center justify-center overflow-hidden bg-linear-to-b from-background via-[#f7fbff] to-[#eaf4ff]">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          {Array.from({ length: 24 }).map((_, i) => (
            <motion.div key={i} className="absolute w-1 h-1 rounded-full bg-[#2563EB]/30"
        ...
        <motion.div style={{ opacity }} className="relative z-10 text-center px-4 max-w-5xl mx-auto pt-20">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.2 }}
            className="inline-flex items-center gap-2 bg-[#2563EB]/8 border border-[#2563EB]/12 rounded-full px-4 py-1.5 text-[#2563EB] text-sm font-medium mb-6">
            <Star size={13} className="fill-[#2563EB]" /> Trusted by 2M+ bettors worldwide
          </motion.div>
          <motion.h1 initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7, delay: 0.3 }}
            className="font-serif text-5xl md:text-7xl font-bold text-[#FFD54A] leading-tight mb-6">
            Best Betting <span style={{ fontFamily: 'Poppins, sans-serif' }} className="text-[#2563EB] text-glow">& </span> <span className="text-[#2563EB] text-glow">Casino Offers</span> Worldwide
          </motion.h1>
          ...
          >
            {[...recentWinners, ...recentWinners].map((w, i) => (
              <div key={i} className="flex items-center gap-2 text-sm shrink-0">
                ...
                <span className="text-[#2563EB] font-bold">{w.amount}</span>
      ...
      <section className="py-20 bg-[#eef6ff] border-y border-[#d6e7f7]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-14">
            <div className="text-[#2563EB] text-sm font-semibold uppercase tracking-widest mb-3">Know before you claim</div>
            <h2 className="font-serif text-4xl md:text-5xl font-bold text-[#FFD54A] mb-4">Types of Casino Bonuses</h2>
              ...
              return (
                <motion.div key={b.title}
                  ...
                  <div className="flex items-start justify-between mb-3">
                    <div className="w-11 h-11 rounded-xl bg-[#2563EB]/8 border border-[#2563EB]/12 flex items-center justify-center">
                  ...
                  <h3 className="font-semibold text-[#F4F8FC] text-lg mb-2">{b.title}</h3>
                  <p className="text-[#C7D5E6] text-sm leading-relaxed">{b.desc}</p>
                </motion.div>
              )
            })}
          </div>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-14">
            <div className="text-[#2563EB] text-sm font-semibold uppercase tracking-widest mb-3">Localised for you</div>
            <h2 className="font-serif text-4xl md:text-5xl font-bold text-[#FFD54A] mb-4">Offers by Country</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {countryOffers.map((c, i) => (
              <motion.div key={c.code}
                ...
                className="bg-[#0F1724] border border-[#162233] rounded-2xl p-6 group transition-all duration-300 cursor-pointer">
                <Link href={`/country/${c.code}`} data-testid={`link-country-card-${c.code}`}>
                  <div className="flex items-center gap-3 mb-4">
                    <span className="text-4xl">{c.flag}</span>
                    <div>
                      <div className="font-semibold text-[#F4F8FC] text-lg">{c.country}</div>
                      <div className="text-[#2563EB] text-sm font-medium">{c.topBonus}</div>
                    </div>
                  </div>
                  <div className="flex flex-wrap gap-1.5 mb-4">
                    {c.sites.map((site) => (
                      <span key={site} className="bg-[#0B1220] border border-[#162233] text-[#C7D5E6] text-xs px-2 py-0.5 rounded-full">{site}</span>
                    ))}
                  </div>
                  <div className="flex items-center gap-1 text-[#2563EB] text-sm font-medium group-hover:gap-2 transition-all">
      ...
      <section className="py-20 bg-[#eef6ff] border-y border-[#d6e7f7]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-14">
            <div className="text-[#2563EB] text-sm font-semibold uppercase tracking-widest mb-3">Bet on anything</div>
            <h2 className="font-serif text-4xl md:text-5xl font-bold text-[#FFD54A] mb-4">Popular Sports &amp; Markets</h2>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            {popularSports.map((s, i) => (
              <motion.div key={s.name}
                ...
                className="bg-[#0F1724] border border-[#162233] rounded-2xl p-5 text-center transition-all duration-300 cursor-pointer">
                <div className="text-4xl mb-3">{s.emoji}</div>
                <div className="font-semibold text-[#F4F8FC] mb-1">{s.name}</div>
                <div className="text-[#2563EB] text-xs font-medium mb-2">{s.markets} markets</div>
          ...
          <div className="text-center mt-10">
            <Link href="/betting-sites">
              <motion.button whileHover={{ scale: 1.03 }} className="inline-flex items-center gap-2 px-6 py-3 border border-[#2563EB]/12 text-[#2563EB] rounded-lg hover:bg-[#2563EB]/8 transition-colors font-medium" data-testid="link-sports-all">
      ...
      <section className="py-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-16">
          <div className="text-[#2563EB] text-sm font-semibold uppercase tracking-widest mb-3">Our promise</div>
          <h2 className="font-serif text-4xl md:text-5xl font-bold text-[#FFD54A] mb-4">Why Choose BetVoxa</h2>
          ...
          {trustFeatures.map((f, i) => {
            ...
            return (
              <motion.div key={f.title}
                initial={{ opacity: 0, y: 24 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: "-40px" }} transition={{ delay: i * 0.08 }}
                whileHover={{ y: -4 }}
                className="bg-white border border-[#ECE6DB] rounded-2xl p-6 hover:border-[#2563EB]/12 transition-all duration-300">
                <div className="w-12 h-12 rounded-xl bg-[#2563EB]/8 border border-[#2563EB]/12 flex items-center justify-center mb-4">
      ...
      <section className="py-20 bg-[#eef6ff] border-y border-[#d6e7f7]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-14">
            ...
            <h2 className="font-serif text-4xl font-bold text-[#FFD54A] mb-4">Accepted Payment Methods</h2>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
            {paymentMethods.map((pm, i) => (
              <motion.div key={pm.name}
                ...
                <div className="w-10 h-10 rounded-lg bg-[#2563EB]/8 flex items-center justify-center mx-auto mb-3">
      ...
      <section className="py-20 bg-linear-to-b from-[#0B0A09] via-[#1B3950]/10 to-[#0B0A09]">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-12">
            <div className="text-[#2563EB] text-sm font-semibold uppercase tracking-widest mb-3">Transparency first</div>
            <h2 className="font-serif text-4xl font-bold text-[#FFD54A] mb-4">How We Rate Operators</h2>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
            {[
              ...
              <motion.div key={item.label}
                ...
                <div className="text-2xl font-bold text-[#2563EB] mb-1">{item.score}</div>
      ...
      <section className="py-20 bg-[#eef6ff] border-y border-[#d6e7f7]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-14">
            ...
            <h2 className="font-serif text-4xl md:text-5xl font-bold text-[#FFD54A] mb-4">Top Betting Sites</h2>
            ...
            {[
              ...
              <motion.div key={site.name}
                ...
                <div className="flex items-start justify-between mb-4">
                  <div className="w-12 h-12 rounded-xl bg-linear-to-br from-[#2563EB]/20 to-[#1B3950]/40 border border-[#E7E1D6] flex items-center justify-center font-bold text-[#2563EB] text-sm font-mono">{site.initials}</div>
                  <div className="flex">{Array.from({ length: 5 }).map((_, j) => <Star key={j} size={11} className={j < Math.round(site.rating) ? "fill-[#2563EB] text-[#2563EB]" : "fill-white/20 text-[#C9C3B8]"} />)}</div>
                </div>
                ...
                <Link href="/betting-sites">
                  <button className="w-full py-2.5 border border-[#2563EB]/12 text-[#2563EB] rounded-lg text-sm font-medium hover:bg-[#2563EB]/8 transition-colors flex items-center justify-center gap-1.5" data-testid={`button-visit-preview-${site.name.toLowerCase()}`}>
          ...
          <div className="text-center mt-8">
            <Link href="/betting-sites">
              <motion.button whileHover={{ scale: 1.03 }} className="inline-flex items-center gap-2 px-6 py-3 border border-[#2563EB]/12 text-[#2563EB] rounded-lg hover:bg-[#2563EB]/8 transition-colors font-medium" data-testid="link-all-betting-sites">
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-14">
            <div className="text-[#2563EB] text-sm font-semibold uppercase tracking-widest mb-3">What bettors say</div>
            <h2 className="font-serif text-4xl font-bold text-[#FFD54A] mb-4">Real Player Reviews</h2>
            ...
            {testimonials.map((t, i) => (
              <motion.div key={t.name}
                ...
                <div className="flex mb-3">
                  {Array.from({ length: t.rating }).map((_, j) => <Star key={j} size={14} className="fill-[#2563EB] text-[#2563EB]" />)}
                </div>
                <p className="text-[#4A433C] text-sm leading-relaxed mb-4 italic">"{t.text}"</p>
                <div className="flex items-center gap-2">
                  <div className="w-8 h-8 rounded-full bg-[#2563EB]/15 flex items-center justify-center text-[#2563EB] font-bold text-xs">{t.name[0]}</div>
                  <div>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-linear-to-r from-[#1B3950]/40 via-[#2563EB]/5 to-[#1B3950]/40 border border-[#2563EB]/12 rounded-3xl p-10 md:p-14 flex flex-col md:flex-row items-center gap-8">
            <div className="flex-1">
              <div className="text-[#2563EB] text-sm font-semibold uppercase tracking-widest mb-3">Mobile experience</div>
              <h2 className="font-serif text-4xl font-bold text-[#FFD54A] mb-4">Bet On the Go</h2>
              ...
              <div className="flex flex-wrap gap-3">
                {["iOS App", "Android App", "Mobile Browser", "Live Betting", "Push Notifications"].map((feat) => (
                  <span key={feat} className="flex items-center gap-1.5 bg-white border border-[#E7E1D6] text-[#5F554C] text-sm px-3 py-1.5 rounded-lg">
                    <CheckCircle size={12} className="text-[#2563EB]" /> {feat}
                  </span>
                ))}
              </div>
            </div>
            <div className="flex gap-3">
              <div className="w-14 h-14 rounded-2xl bg-[#2563EB]/8 border border-[#2563EB]/12 flex items-center justify-center"><Smartphone size={28} className="text-[#2563EB]" /></div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 relative overflow-hidden">
        <div className="absolute inset-0 bg-linear-to-r from-[#1B3950]/30 via-[#2563EB]/5 to-[#1B3950]/30" />
        <div className="relative max-w-2xl mx-auto text-center px-4">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            <div className="text-[#2563EB] text-sm font-semibold uppercase tracking-widest mb-3">Stay ahead</div>
            ...
            {faqs.map((faq, i) => (
              <motion.div key={i}
                ...
                <button onClick={() => setOpenFaq(openFaq === i ? null : i)}
                  ...
                  {openFaq === i ? <ChevronUp size={16} className="text-[#2563EB] shrink-0" /> : <ChevronDown size={16} className="text-[#8D847A] shrink-0" />}
                </button>
                <AnimatePresence>
                  {openFaq === i && (
      ...
      <section className="py-28 relative overflow-hidden bg-background">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
          ...
          <h2 className="font-serif text-5xl md:text-6xl font-bold text-[#1F1A17] mb-4">
            Ready to <span className="text-[#2563EB] text-glow">Win Big?</span>
          </h2>
