    ...
    <div className="overflow-x-hidden">
      <section className="relative py-16 sm:py-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h1 className="font-serif text-4xl md:text-5xl font-bold text-[#1F1A17] mb-3">Casinos</h1>
          <p className="text-[#5F554C] text-base max-w-2xl mx-auto">
            Real offers fetched from the API, presented in the same light sky-blue and white style used across the site.
          </p>
        </motion.div>
