  ...
  return (
    <div className="min-h-screen bg-[#F8F7F2]">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {topPicks.map((pick, i) => (
            <motion.div key={pick.label} initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: i * 0.08 }}
              className="bg-[#D97706]/5 border border-[#D97706]/12 rounded-xl p-4">
          ...
          <table className="w-full text-sm">
            ...
            <tbody>
              {allBonuses.slice(0, 8).map((b, i) => (
                <tr key={b.name} className={`border-b border-[#EFE9DE] ${i % 2 === 0 ? "bg-[#FAF8F3]" : "bg-white"} hover:bg-[#D97706]/5 transition-colors`}>
                  ...
                  <td className="px-5 py-3.5">
                    <div className="flex">{Array.from({ length: 5 }).map((_, j) => <Star key={j} size={11} className={j < Math.round(b.rating) ? "fill-[#D97706] text-[#D97706]" : "fill-white/20 text-[#C9C3B8]"} />)}</div>
                  </td>
          ...
          <div className="flex flex-wrap gap-2">
            {countries.map((c) => (
              <button key={c} onClick={() => setCountryFilter(c)}
                className={`px-3 py-1.5 rounded-lg text-sm font-medium transition-all ${countryFilter === c ? "bg-[#D97706] text-[#0B0A09]" : "bg-white text-[#5F554C] hover:bg-[#FAF8F3] border border-[#E7E1D6]"}`}
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-10 items-center">
            ...
            <motion.div initial={{ opacity: 0, x: 20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}
              ...
              <h3 className="font-semibold text-[#1F1A17] mb-4 flex items-center gap-2"><Check size={16} className="text-[#D97706]" /> Key Terms Glossary</h3>
      ...
      <section className="py-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-10 bg-[#D97706]/5 border border-[#D97706]/12 rounded-2xl p-6 md:p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <motion.div key={item.title} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.1 }}
                ...
                <div className="w-12 h-12 rounded-xl bg-[#D97706]/8 flex items-center justify-center mx-auto mb-4">
